...
def press(num):
    ...
    #print(equation.get()) #Este print es para confirmar que imprime datos ingresados
...
miltiply = Button(root, text=' * ', fg='#fff', background='#fe9727', command=lambda: press('*'))
miltiply.grid(row=3, column=3, sticky='nswe')
